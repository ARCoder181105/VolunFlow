        ...
        >
          ...
          >
            <p className="text-sm text-gray-600">
              ...
              <a 
                href="/register" 
                className="font-semibold text-blue-600 hover:text-blue-500 transition-colors inline-flex items-center gap-1 group"
              >
                Sign up
          ...
          <div className="relative h-full flex flex-col justify-center px-8 xl:px-12 text-white">
            ...
            >
              ...
              <p className="text-base text-white/90 mb-6">
                Connect with NGOs, discover volunteering opportunities, and create lasting impact in your community.
              </p>
